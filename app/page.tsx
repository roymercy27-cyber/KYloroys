...
export default function DashboardPage() {
  ...
  const [view, setView] = useState('main'); // 'main' or 'outbound_call'
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 font-sans text-slate-900">
      {/* SIDEBAR */}
      <aside className="fixed inset-y-0 left-0 w-64 bg-orange-500 text-white p-6 flex flex-col gap-8 shadow-2xl z-50">
        <div className="flex items-center gap-3 text-2xl font-bold uppercase tracking-tighter">
          <div className="bg-white text-orange-500 p-2 rounded-xl shadow-lg"><SchoolIcon /></div>
          Uplog
        </div>
      ...
      <main className="flex-1 ml-64 p-12">
        ...
        {activeTab === 'Dashboard' && (
          <div className="space-y-10">
            ...
            {view === 'outbound_call' ? (
              /* OUTBOUND SCREEN [User Request: "It should say zero ultimate calls"] */
